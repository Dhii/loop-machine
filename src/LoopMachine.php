...
class LoopMachine implements SplSubject
{
    ...
    /**
     * Processes a given list of items.
     *
     * @since [*next-version*]
     *
     * @param array|Traversable $items The traversable list of items.
     *
     * @return $this This instance.
     */
    public function process($items)
    {
        $this->_processStart($items);

        foreach ($items as $_item) {
            $this->_processLoop($items, $_item);
        }

        $this->_processEnd($items);

        return $this;
    }

    /**
     * Starts the processing of the item list.
     *
     * @since [*next-version*]
     *
     * @param array|Traversable $items The traversable list of items.
     ...
     * @return $this This instance.
     */
    protected function _processStart($items)
    {
     ...
     * @return $this This instance.
     */
    protected function _processLoop($items, $item)
    {
    ...
    /**
     * Ends the processing of the item list.
     *
     * @since [*next-version*]
     *
     * @param array|Traversable $items The traversable list of items.
     ...
     * @return $this This instance.
     */
    protected function _processEnd($items)
    {
